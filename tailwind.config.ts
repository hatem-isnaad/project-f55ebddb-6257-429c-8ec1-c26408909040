    ...
    extend: {
      ...
      colors: {
        ...
        company: {
          ...
          "sidebar-active": "hsl(var(--company-sidebar-active))",
          "sidebar-active-foreground": "hsl(var(--company-sidebar-active-foreground))",
        },
        admin: {
          ...
          "sidebar-active-foreground": "hsl(var(--admin-sidebar-active-foreground))",
        },
        kanban: {
          pending: "hsl(var(--kanban-pending))",
          "pending-border": "hsl(var(--kanban-pending-border))",
          progress: "hsl(var(--kanban-progress))",
          "progress-border": "hsl(var(--kanban-progress-border))",
          completed: "hsl(var(--kanban-completed))",
          "completed-border": "hsl(var(--kanban-completed-border))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
